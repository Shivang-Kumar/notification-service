package com.notification.processor.bootstrap;
...
public class ConnectionValidator {
  ...
  {
	  try(AdminClient client=AdminClient.create(Map.of("bootstrap-servers",properties.getBootStrapKakfaServers()))){
	  ...
	  {
		  log.error("Error while pinging kafka connection");
